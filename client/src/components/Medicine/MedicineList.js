                ...
                <div className="content">
                    <div className="row">
                        ...
                        <div className="col-sm-8 col-9 text-right m-b-20">
                            <Link to="/medicines/add" className="btn btn-primary float-right btn-rounded" style={{backgroundColor: '#b5344a', color: 'white', border: 'none'}}>
                    ...
                    <form action="/medicines" name="userFilter" >
                        <div className="row filter-row">
                            ...
                            <div className="col-sm-4 col-md-4">
                                <button type="submit" className="btn btn-primary btn-block" style={{backgroundColor: '#b5344a', color: 'white', border: 'none'}}> Search </button>
                            </div>
                        </div>
                    </form>
