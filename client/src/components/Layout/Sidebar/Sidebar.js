...
export default function Sidebar({ open, handleDrawerClose, handleDrawerOpen }) {
    ...
    return (
        <Drawer className={styles.sidebar} variant="permanent" open={open} onMouseEnter={handleDrawerOpen} onMouseLeave={handleMouseLeavesDrawer} PaperProps={{ sx: { backgroundColor: '#b5344a', color: 'white' } }}>
            <DrawerHeader>
